...
//Funci�n para insertar un nodo al principio de la lista
int InsertarInicio(NODO **cabeza, int dato)
{
    NODO* nuevo = NULL;
...
//Funci�n para imprimir todos los datos de la lista
void ImprimirLista(NODO *cabeza)
{
    NODO *nAux = cabeza;
...
//Funci�n para verificar si una lista est� vac�a
int EstaVacia(NODO *cabeza)
{
    if ( cabeza == NULL)
        return 1;
...
//Funci�n para verificar si existe un elemento en la lista
int ExisteElemento(NODO *cabeza, int dato)
{
    NODO *nAux = cabeza;
